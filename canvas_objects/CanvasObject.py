from canvas_objects.StaticDraggableObject import StaticDraggableObject
from canvas_objects.TextObject import TextObject
from canvas_objects.ClickableObject import ClickableObject
from canvas_objects.ClonableObject import ClonableObject
...
class CanvasObject:
    ...
    def insideObject(self, x, y):
        ...
        # if x >= (self.obj.x - halfWidth) and x <= (self.obj.x + halfWidth) and \
        #         y >= (self.obj.y - halfHeight) and y <= (self.obj.y + halfHeight):
